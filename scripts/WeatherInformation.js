...
var apiKey = "b3f802b78de24505b4923919231302" 
var zipCode = "29456" //29445 is goose creek so change this unless you live there
...
fetch(apiUrl).then(response => {
	...
	concat = concat + "Current temperature: " + data.current.temp_f + " degrees fahrenheit" + "\n"
	concat = concat + "Feels like: " + data.current.feelslike_f + " degrees fahrenheit" + "\n"
